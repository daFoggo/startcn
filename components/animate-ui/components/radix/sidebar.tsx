...
/** biome-ignore-all lint/suspicious/noDocumentCookie: <dontcare> */
"use client";
...
function SidebarGroupLabel({
	...
	return (
		<Comp
			...
			className={cn(
				"flex items-center px-2 rounded-md outline-hidden ring-sidebar-ring focus-visible:ring-2 h-8 [&>svg]:size-4 font-medium text-sidebar-foreground/70 text-xs transition-[margin,opacity] duration-300 ease-linear shrink-0 [&>svg]:shrink-0",
