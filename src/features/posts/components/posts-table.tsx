    ...
    const postColumns = useMemo<ColumnDef<Post>[]>(
        () => [
            ...
            },
            {
                ...
                cell: ({ row }) => <div className="truncate max-w-[300px]" title={row.original.title}>{row.original.title}</div>,
                meta: {
                    label: "Title",
            ...
            },
            {
                ...
                cell: ({ row }) => <div className="truncate max-w-[500px]" title={row.original.body}>{row.original.body}</div>,
                meta: {
                    label: "Body",
            ...
            },
            {
                ...
                accessorKey: "userId",
                header: ({ column }) => (
                    <DataTableColumnHeader column={column} title="User ID" label="User ID" />
                ),
