...
export const markdownContentClassName = cn(
	...
	"[&_p]:my-2 [&_pre]:my-4 [&_pre]:overflow-x-auto [&_pre]:rounded-lg [&_pre]:border [&_pre]:bg-muted [&_pre]:px-4 [&_pre]:py-3",
	"[&_pre_code]:bg-transparent [&_pre_code]:p-0",
	"[&_table]:my-4 [&_table]:w-full [&_table]:border-collapse [&_td]:border [&_td]:px-3 [&_td]:py-2",
